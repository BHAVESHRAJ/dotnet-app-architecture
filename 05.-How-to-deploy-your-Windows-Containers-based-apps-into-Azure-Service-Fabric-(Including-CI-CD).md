...
However, and for simplicity's sake, you can also use the public eShopModernizedMVC Docker image available at Docker Hub and published by our team. That image is available here:
eShopModernizedMVC Windows Docker Image: https://hub.docker.com/r/eshop/modernizedmvc/
eShopModernizedWebForms Windows Docker Image: https://hub.docker.com/r/eshop/modernizedwebforms/
