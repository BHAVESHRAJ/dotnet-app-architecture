...
Copy the client certificates plus the rooCA certificate into the user folder **C:\Users\YOUR-USER\.docker** either at the server for testing and also at the client docker machine to connect from:
