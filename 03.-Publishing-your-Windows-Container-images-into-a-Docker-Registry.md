...
### Option 1.A (Straightforward): Use a single script to build your All the apps and create All the Windows Container images


### Option 1.B (Manual steps per app and Windows Container images): Build/Publish your app's files with Visual Studio and create your Windows Container image with Docker CLI (docker-compose build or docker build)
...
![image](https://user-images.githubusercontent.com/1712635/38701251-3dbebbfa-3e52-11e8-8271-c2bb8cc91d27.png)
