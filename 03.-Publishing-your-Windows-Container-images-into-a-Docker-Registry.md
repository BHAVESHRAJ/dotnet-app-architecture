##  Overview
When deploying Docker containers (including Windows Containers and Linux containers) into production environments, you need to deploy pull its related Docker image first ("docker pull") from a Docker Registry.
Therefore, if you are creating a custom application which is running as a container, you also need to know how to create its related custom Docker image and how to publish it into a Docker Registry. 
