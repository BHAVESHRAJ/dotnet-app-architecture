...
In a PowerShell window or CMD window, move to your `eShopModernizing root folder`, then run the [Build.cmd](https://github.com/dotnet-architecture/eShopModernizing/blob/master/build.cmd) script as the following execution:
